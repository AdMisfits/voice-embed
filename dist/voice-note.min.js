"use strict";(()=>{var f=class extends HTMLElement{constructor(){super();this.ctx=null;this.audioContext=null;this.isPlaying=!1;this.peaks=[];this.animationFrame=null;this.hasUserInteracted=!1;this.currentProgress=0;this.isGeneratingWaveform=!1;this.cacheKey="";this.hoveredBar=null;this.clickedBar=null;this.speeds=[1,1.25,1.5,2];this.currentSpeedIndex=0;this.resizeObserver=null;this.shadow=this.attachShadow({mode:"open"}),this.audio=document.createElement("audio"),this.audio.preload="metadata",this.audio.crossOrigin="anonymous",this.playButton=document.createElement("button"),this.timeDisplay=document.createElement("span"),this.speedButton=document.createElement("button"),this.canvas=document.createElement("canvas"),this.container=document.createElement("div"),this.setupDOM(),this.attachEventListeners()}static get observedAttributes(){return["src"]}setupDOM(){let t=document.createElement("style");t.textContent=`
      :host {
